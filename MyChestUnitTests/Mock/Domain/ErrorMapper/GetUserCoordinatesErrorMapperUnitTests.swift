//
//  GetUserCoordinatesErrorMapperUnitTests.swift
//  MyChestUnitTests
//
...
final class GetUserCoordinatesErrorMapperUnitTests: XCTestCase {
    ...
    func test_map_invalidUrl() {
        ...
        // When
        let result = GetUserCoordinatesErrorMapper.map(error)
