//
//  GetLocalNotificationErrorMapperUnitTests.swift
//  MyChestUnitTests
//
...
final class GetLocalNotificationErrorMapperUnitTests: XCTestCase {
    ...
    func test_map_invalidUrl() {
        ...
        // When
        let result = GetLocalNotificationErrorMapper.map(error)
